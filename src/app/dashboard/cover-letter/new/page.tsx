...
import { DEFAULT_COVER_LETTER } from "@/types/cover-letter";
...
export default function NewCoverLetterPage() {
  ...
  const handleSave = () => {
    try {
      ...
      const next = [...list, { ...data, updatedAt: new Date().toISOString() }];
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-slate-600">
        Add job details and use AI to generate or improve your letter.
      </p>
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              ...
              <label className="block">
                <span className="text-sm font-medium text-slate-700">
                  Link resume (optional, for AI)
                </span>
                <select
                  value={data.resumeId ?? ""}
                  onChange={(e) =>
                    update({ resumeId: e.target.value || null })
                  }
                  className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
                >
              ...
              <label className="block">
                <span className="text-sm font-medium text-slate-700">
                  Job description (optional, improves AI)
                </span>
                <textarea
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <textarea
              ...
              placeholder="Write or paste your cover letter here. Use 'Generate with AI' to create one from job details and your resume."
            />
          </div>
